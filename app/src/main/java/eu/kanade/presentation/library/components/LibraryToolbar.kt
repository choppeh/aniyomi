...
fun LibraryToolbar(
    ...
    selectedCount > 0 -> LibrarySelectionToolbar(
        ...
        onClickRefreshDownloads = onClickRefreshDownloads,
        ...
        actions = {
            ...
            AppBarActions(
                persistentListOf(
                    ...
                    AppBar.OverflowAction(
                        title = stringResource(MR.strings.action_check_downloads),
                        onClick = onClickRefreshDownloads,
                    ),
                ),
            )
        },
